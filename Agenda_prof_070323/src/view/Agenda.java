...
public class Agenda extends JFrame {
	...
	public Agenda() {
		...
		btnClear.setToolTipText("Limpar os Campos");
		btnClear.setIcon(new ImageIcon(Agenda.class.getResource("/img/clar.png")));
		btnClear.setBounds(230, 252, 64, 64);
	...
	/**
	 * Método para adicionar um conatato no banco
	 */
	...
	//validação de campos obrigatorios
	 ...
	 //a linha abaixo cria uma variavel de nome create que recebe o codigo sql
	    ...
	    try {
			//abrir a conexão com o banco
	    	con = dao.conectar();
	    	// Uso da classe PreparedStatement para executar a instrução sql e replicar no banco
	    	pst = con.prepareStatement(create);
	    	// setar (definir) os parâmetos (?,?,?) de acordo com o preenchimento das caixas de texto
